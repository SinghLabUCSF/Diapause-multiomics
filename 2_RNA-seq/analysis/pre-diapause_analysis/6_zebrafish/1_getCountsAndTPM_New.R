...
# Input variables ---------------------------
genename = "gene_id"
gtffile = "/Volumes/Mybook_3/Other_organism_genomes/drerio/Danio_rerio.GRCz11.100.gtf" # Needs to download from Ensembl
outfilepath = "../../../feature_counts"
sampleTable <- read.csv("../../../fastq/drer/experimental_design_zebrafish.csv", row.names = 1, stringsAsFactors = F)
# ------------------------------------------
sampleTable$files
