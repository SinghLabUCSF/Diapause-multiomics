...
# Input variables ---------------------------
genename = "gene_id"
gtffile = "/Volumes/Mybook_3/Other_organism_genomes/olati/Oryzias_latipes.ASM223467v1.100.gtf" # Needs to download from Ensembl
outfilepath = "../../../feature_counts"
sampleTable <- read.csv("../../../fastq/olat/experiment_design_medaka.csv", row.names = 1, stringsAsFactors = F)
# ------------------------------------------
sampleTable$files
