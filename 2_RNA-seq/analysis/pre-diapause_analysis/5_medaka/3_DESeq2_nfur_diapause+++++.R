...
sampleTable <- read.csv("../../../fastq/olat/experiment_design_medaka.csv", row.names = 1)
sampleTable

library("DESeq2")

countdata = read.csv("Counts_medaka_development_all.csv", row.names = 1)
colnames(countdata)
...
write.table(normcounts, file="CountsNormDESeq2_medaka_development_all.csv", sep= ",")
head(normcounts)
