...
## -------------------------------------------------------------------------------------------------------------------
my $designfile = '../../../fastq/olat/experiment_design_medaka.csv';
my $tpmfile = '../../../feature_counts';
my $outct = 'Counts_medaka_development_all.csv';
my $outtpm = 'TPM_medaka_development_all.csv';
my $outlen = 'GeneLengths_medaka_development_all.csv';
## -------------------------------------------------------------------------------------------------------------------
