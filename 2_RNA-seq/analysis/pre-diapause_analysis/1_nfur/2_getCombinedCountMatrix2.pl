...
## -------------------------------------------------------------------------------------------------------------------
my $designfile = '../../../fastq/nfur_ast_aaul/experiment_design_nfur_young.csv';
my $tpmfile = '../../../feature_counts';
my $outct = 'Counts_nfur_young.csv';
my $outtpm = 'TPM_nfur_young.csv';
my $outlen = 'GeneLengths_nfur_young.csv';
## -------------------------------------------------------------------------------------------------------------------
