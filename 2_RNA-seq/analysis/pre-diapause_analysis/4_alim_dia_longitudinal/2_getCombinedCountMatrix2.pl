...
## -------------------------------------------------------------------------------------------------------------------
my $designfile = '../../../fastq/alim_dia_longitudinal/experiment_design.csv';
my $tpmfile = '../../../feature_counts';
my $outct = 'Counts_alim_dia-longitudinal.csv';
my $outtpm = 'TPM_alim_dia-longitudinal.csv';
my $outlen = 'GeneLengths_alim_dia-nondia.csv';
## -------------------------------------------------------------------------------------------------------------------
