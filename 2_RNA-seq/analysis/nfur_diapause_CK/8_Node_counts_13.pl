...
my $infile = '4_Paralog_classification/3_Orthofinder_13spp'; 
my $outfile = '5_Node_counts/3_Orthofinder_13spp';           
...
my @all_nodes = ('Chordata and above',
'Vertebrata',
'Gnathostomata,Euteleostomi,',
'Actinopterygii,Neopterygii',
'Osteoglossocephalai,Clupeocephala',
'Euteleosteomorpha,Acanthomorphata',
'Euacanthomorphacea,Percomorphaceae,Ovalentaria',
'Atherinomorphae,Cyprinodontiformes',
'Cyprinodontoidei',
'Aplocheiloidei',
'Nothobranchiidae',
...
# Vertebrate nodes
my %Vertebrate_nodes = ('Chordata and above' => '',
'Vertebrata' => '',
'Gnathostomata,Euteleostomi,' => '');

# Fish nodes
my %Fish_nodes = ('Actinopterygii,Neopterygii' => '',
'Osteoglossocephalai,Clupeocephala' => '',
'Euteleosteomorpha,Acanthomorphata' => '',
'Euacanthomorphacea,Percomorphaceae,Ovalentaria' => '');

# Killifish nodes
my %Killifish_nodes = ('Atherinomorphae,Cyprinodontiformes' => '',
'Cyprinodontoidei' => '',
'Aplocheiloidei' => '',
'Nothobranchiidae' => '',
'nothobranchius_furzeri' => '');
