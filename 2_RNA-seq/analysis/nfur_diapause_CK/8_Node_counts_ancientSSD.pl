...
my $out_suffix = 'le20_AncientSSD'; # Only1DupEvent or le20 or OnlyMostSimilar. **** ALSO CHANGE THE PARALOG FILE BELOW.
...
foreach (@file){
	...
	# global criteria	
	# restrict to only SSD excluding both WGD events
