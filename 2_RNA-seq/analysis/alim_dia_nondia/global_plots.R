...
file = read.table("alimnaeus_DuplicatesClassification_All_le20_Reordered.txt", header = T, sep = "\t")
head(file)

# I am doing KS test one sided, because wth 2 sides the exact p-value can not be calculated
p1 = ks.test(file$median.Diapause.alim.1[file$Category == 'NeoF'],
             file$median.Development.alim.1[file$Category == 'NeoF'],
             alternative = "l")$p.value
p2 = ks.test(file$median.Diapause.alim.2[file$Category == 'NeoF'],
             file$median.Development.alim.2[file$Category == 'NeoF'], 
             alternative = "g")$p.value

pdf(file = "BoxPlot_2C.pdf", width = 6, height = 6)
boxplot(file$median.Diapause.alim.1[file$Category == 'NeoF'],
        file$median.Development.alim.1[file$Category == 'NeoF'],
        file$median.Diapause.alim.2[file$Category == 'NeoF'],
        file$median.Development.alim.2[file$Category == 'NeoF'],
        outline = F)
...
#          outline = F)
#  
# boxplot(file$median.Diapause.alim.2[file$Category == 'NeoF'],
#          file$median.Development.alim.2[file$Category == 'NeoF'],
#          outline = F)
# 
# boxplot(file$median.Development.alim.1[file$Category == 'NeoF'],
#         file$median.Development.alim.2[file$Category == 'NeoF'],
#         outline = F)
# 


# boxplot(file$median.Diapause.alim.1[file$Category == 'Both up'],
#         file$median.Development.alim.1[file$Category == 'Both up'],
#         file$median.Diapause.alim.2[file$Category == 'Both up'],
#         file$median.Development.alim.2[file$Category == 'Both up'],
#         outline = F)
# 
